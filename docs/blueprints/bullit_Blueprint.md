...
Hit-wall practice asset; event nodes are disconnected.

[Back to walkthrough](README.md) · [Open Blueprint asset](../../Content/blueprints/hitwall/bullit_Blueprint.uasset)
...
| --- | --- | --- | --- |
| 6 | `ReceiveBeginPlay` | — | Unconnected |
| 7 | `ReceiveActorBeginOverlap` | — | Unconnected |
| 8 | `ReceiveTick` | — | Unconnected |
...
| ID | Node | Connected inputs and stored defaults | Outputs |
| --- | --- | --- | --- |
| 9 | `UserConstructionScript` | — | Unconnected |
